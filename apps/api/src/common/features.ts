...
export const FEATURES = {
  ...
  /**
   * When ON  : Patient can log in via OTP SMS, and set/reset their PIN.
   * When OFF : OTP login is disabled. Patients must use PIN generated by receptionist.
   * Default  : ON (default for convenience, can be flipped via environment variable)
   */
  CUSTOMER_OTP_LOGIN: (process.env.CUSTOMER_OTP_LOGIN ?? 'true') === 'true',
